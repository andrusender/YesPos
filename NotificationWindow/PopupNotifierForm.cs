...
namespace NotificationWindow
{
    ...
    internal class PopupNotifierForm : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // PopupNotifierForm
            // 
            this.ClientSize = new System.Drawing.Size(350, 65);
        ...
        private void AllocateGDIObjects()
        {
            ...
            penCloseButton = new Pen(Parent.CloseButtonColor, 2);
        ...
        private void PopupNotifierForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (Parent.ShowCloseButton)
            {
                ...
                e.Graphics.DrawLine(penCloseButton, RectClose.Left + 4, RectClose.Top + 4, RectClose.Right - 4, RectClose.Bottom - 4);
                e.Graphics.DrawLine(penCloseButton, RectClose.Left + 4, RectClose.Bottom - 4, RectClose.Right - 4, RectClose.Top + 4);
            }
            if (Parent.ShowOptionsButton)
            {
                if (mouseOnOptions)
