...
i++) {
        ...
        this.descend = function (prototypeParent, childProperties) {
            function protoSetter() { } protoSetter.prototype = prototypeParent;
...
i++) {
        ...
        var escapeEntitiesRegEx = { normal: function (list) {
            var chars = [];
            for (var ch in list) {
                chars.push(ch)
...
++i) {
            ...
            var o = FBL.extend({ type: "get", async: true, dataType: "text", contentType: "application/x-www-form-urlencoded" }, options || {});
...
i++) {
        ...
        this.SourceLink.prototype = { toString: function () {
            return this.href
        }, toJSON: function () {
...
m = reg.exec(format)) {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            var reps = [];
            var parentPanelMap = {};
            FBL.Firebug = { version: "Firebug Lite 1.4.0", revision: "$Revision: 11967 $", modules: modules, panelTypes: panelTypes, panelTypeMap: panelTypeMap, reps: reps, initialize: function () {
                if (FBTrace.DBG_INITIALIZE) {
...
i++) {
            ...
            Firebug.Listener.prototype = { addListener: function (listener) {
                if (!this.fbListeners) {
                    this.fbListeners = []
...
++i) {
            ...
            }, startInspecting: function () { }, stopInspecting: function (object, cancelled) { }, search: function (text, reverse) { }, getSearchOptionsMenuItems: function () {
...
curPos++) { } function transformIndex(index) {
    if (reverse) {
...
next++) {
                ...
                return []
            }, getEditor: function (target, value) { }, getDefaultSelection: function () {
                return null
            }, browseObject: function (object) { }, getPopupObject: function (target) {
                return Firebug.getRepObject(target)
            }, getTooltipObject: function (target) {
                return Firebug.getRepObject(target)
            }, showInfoTip: function (infoTip, x, y) { }, getObjectPath: function (object) {
                return null
            ...
            }, breakOnNext: function (armed) { }, shouldBreakOnNext: function () {
                return false
            ...
            Firebug.MeasureBox = { startMeasuring: function (target) {
                if (!this.measureBox) {
            ...
            if (FBL.domplate) {
                Firebug.Rep = domplate({ className: "", inspectable: true, supportsObject: function (object, type) {
                    return false
    ...
    FBL.ns(function () {
        with (FBL) {
            FBL.Controller = { controllers: null, controllerContext: null, initialize: function (context) {
                this.controllers = [];
...
i++) {
            ...
            FBL.PanelBar = { panelMap: null, selectedPanel: null, parentPanelName: null, create: function (ownerPanel) {
                this.panelMap = {};
...
i++) {
            ...
            Button.prototype = extend(Controller, { type: "normal", caption: "caption", title: null, className: "", baseClassName: "fbButton", pressedClassName: "fbBtnPressed", element: null, container: null, owner: null, state: null, display: null, destroy: function () {
                this.shutdown();
...
i++) {
            ...
            var menuMap = {};
            Menu.prototype = extend(Controller, { destroy: function () {
                this.hide();
                if (this.parentMenu) {
...
i++) {
            ...
            append(Menu, { register: function (object) {
...
i++) {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            FBL.FirebugChrome = { chromeMap: {}, htmlSelectionStack: [], create: function () {
                if (FBTrace.DBG_INITIALIZE) {
            ...
            append(ChromeBase, { node: null, type: null, document: null, window: null, sidePanelVisible: false, commandLineVisible: false, largeCommandLineVisible: false, inspectButton: null, create: function () {
                ...
                var firebugOptionsMenu = { id: "fbFirebugOptionsMenu", getItems: function () {
...
i++) {
            ...
            var ChromeFrameBase = extend(ChromeBase, { create: function () {
            ...
            var ChromeMini = extend(Controller, { create: function (chrome) {
                append(this, chrome);
                this.type = "mini"
            }, initialize: function () {
                Controller.initialize.apply(this);
            ...
            var ChromePopupBase = extend(ChromeBase, { initialize: function () {
    ...
    FBL.ns(function () {
        with (FBL) {
            var sourceMap = {};
            Firebug.Lite.Proxy = { _callbacks: {}, load: function (url) {
                ...
                var script = createGlobalElement("script"), doc = Firebug.context.document, uid = "" + new Date().getTime(), callbackName = "callback=Firebug.Lite.Proxy._callbacks." + uid, jsonpURL = url.indexOf("?") != -1 ? url + "&" + callbackName : url + "?" + callbackName;
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            Firebug.Lite.Script.prototype = { isLineExecutable: function () { }, pcToLine: function () { }, lineToPc: function () { }, toString: function () {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            Firebug.Lite.Browser.prototype = { toString: function () {
...
i += 1) {
    ...
    (function () {
        var store = (function () {
            var api = {}, win = window, doc = win.document, localStorageName = "localStorage", globalStorageName = "globalStorage", namespace = "__firebug__storejs__", storage;
            api.disabled = false;
...
i++) {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            Firebug.Inspector = { create: function () {
...
++i) {
        ...
        FBL.DomplateTag.prototype = { merge: function (args, oldTag) {
            if (oldTag) {
...
++i) {
        ...
        FBL.DomplateEmbed.prototype = copyObject(FBL.DomplateTag.prototype, { merge: function (args, oldTag) {
        ...
        FBL.DomplateLoop.prototype = copyObject(FBL.DomplateTag.prototype, { merge: function (args, oldTag) {
...
++i) {
        ...
        var Renderer = { renderHTML: function (args, outputs, self) {
            var code = [];
...
++i) {
    ...
    var FirebugReps = FBL.ns(function () {
        with (FBL) {
            ...
            this.Undefined = domplate(Firebug.Rep, { tag: OBJECTBOX("undefined"), className: "undefined", supportsObject: function (object, type) {
                return type == "undefined"
            } 
            });
            this.Null = domplate(Firebug.Rep, { tag: OBJECTBOX("null"), className: "null", supportsObject: function (object, type) {
                return object == null
            } 
            });
            this.Nada = domplate(Firebug.Rep, { tag: SPAN(""), className: "nada" });
            this.Number = domplate(Firebug.Rep, { tag: OBJECTBOX("$object"), className: "number", supportsObject: function (object, type) {
                return type == "boolean" || type == "number"
            } 
            });
            this.String = domplate(Firebug.Rep, { tag: OBJECTBOX("&quot;$object&quot;"), shortTag: OBJECTBOX("&quot;$object|cropString&quot;"), className: "string", supportsObject: function (object, type) {
                return type == "string"
            } 
            });
            ...
            this.Func = domplate(Firebug.Rep, { tag: OBJECTLINK("$object|summarizeFunction"), summarizeFunction: function (fn) {
...
child = child.previousSibling) {
            ...
            this.Property = domplate(Firebug.Rep, { supportsObject: function (object) {
            ...
            this.NetFile = domplate(this.Obj, { supportsObject: function (object) {
            ...
            this.Except = domplate(Firebug.Rep, { tag: OBJECTBOX({ _repObject: "$object" }, "$object.message"), className: "exception", supportsObject: function (object) {
                            ...
                            if (attr.nodeName == "id") {
                                ...
                                if (attr.nodeName == "class") {
                                    ...
                                    if (attr.nodeName == "style") {
                                        attrs.push({ nodeName: attr.nodeName, nodeValue: attr.nodeValue || elt.style.cssText.replace(/([^\s]+)\s*:/g, function (m, g) {
...
++i) {
            ...
            this.TextNode = domplate(Firebug.Rep, { tag: OBJECTLINK("&lt;", SPAN({ "class": "nodeTag" }, "TextNode"), "&nbsp;textContent=&quot;", SPAN({ "class": "nodeValue" }, "$object.textContent|cropString"), "&quot;", "&gt;"), className: "textNode", supportsObject: function (object) {
                return object instanceof Text
            } 
            });
            this.Document = domplate(Firebug.Rep, { tag: OBJECTLINK("Document ", SPAN({ "class": "objectPropValue" }, "$object|getLocation")), getLocation: function (doc) {
            ...
            this.StyleSheet = domplate(Firebug.Rep, { tag: OBJECTLINK("StyleSheet ", SPAN({ "class": "objectPropValue" }, "$object|getLocation")), getLocation: function (styleSheet) {
            ...
            this.Window = domplate(Firebug.Rep, { tag: OBJECTLINK("Window ", SPAN({ "class": "objectPropValue" }, "$object|getLocation")), getLocation: function (win) {
                try {
            ...
            this.Event = domplate(Firebug.Rep, { tag: TAG("$copyEventTag", { object: "$object|copyEvent" }), copyEventTag: OBJECTLINK("$object|summarizeEvent"), summarizeEvent: function (event) {
                var info = [event.type, " "];
            ...
            this.SourceLink = domplate(Firebug.Rep, { tag: OBJECTLINK({ $collapsed: "$object|hideSourceLink" }, "$object|getSourceLinkTitle"), hideSourceLink: function (sourceLink) {
            ...
            this.SourceFile = domplate(this.SourceLink, { tag: OBJECTLINK({ $collapsed: "$object|hideSourceLink" }, "$object|getSourceLinkTitle"), persistor: function (context, href) {
...
++i) {
            ...
            this.StackTrace = domplate(Firebug.Rep, { tag: FOR("frame", "$object.frames focusRow", TAG(this.StackFrame.tag, { object: "$frame" })), className: "stackTrace", supportsObject: function (object) {
                return object instanceof StackTrace
            } 
            });
            this.jsdStackFrame = domplate(Firebug.Rep, { inspectable: false, supportsObject: function (object) {
            ...
            this.Assert = domplate(Firebug.Rep, { tag: DIV(DIV({ "class": "errorTitle" }), DIV({ "class": "assertDescription" })), className: "assert", inspectObject: function (error, context) {
                var sourceLink = this.getSourceLink(error);
                Firebug.chrome.select(sourceLink)
            }, getContextMenuItems: function (error, target, context) {
                var breakOnThisError = this.hasErrorBreak(error);
            ...
            this.SourceText = domplate(Firebug.Rep, { tag: DIV(FOR("line", "$object|lineIterator", DIV({ "class": "sourceRow", role: "presentation" }, SPAN({ "class": "sourceLine", role: "presentation" }, "$line.lineNo"), SPAN({ "class": "sourceRowText", role: "presentation" }, "$line.text")))), lineIterator: function (sourceText) {
...
++i) {
            ...
            this.nsIDOMHistory = domplate(Firebug.Rep, { tag: OBJECTBOX({ onclick: "$showHistory" }, OBJECTLINK("$object|summarizeHistory")), className: "nsIDOMHistory", summarizeHistory: function (history) {
                try {
            ...
            this.ApplicationCache = domplate(Firebug.Rep, { tag: OBJECTBOX({ onclick: "$showApplicationCache" }, OBJECTLINK("$object|summarizeCache")), summarizeCache: function (applicationCache) {
                try {
            ...
            this.Storage = domplate(Firebug.Rep, { tag: OBJECTBOX({ onclick: "$show" }, OBJECTLINK("$object|summarize")), summarize: function (storage) {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            Firebug.Editor = extend(Firebug.Module, { supportsStopEvent: true, dispatchName: "editor", tabCharacter: "    ", startEditing: function (target, value, editor) {
                this.stopEditing();
...
++i) {
            ...
            Firebug.BaseEditor = extend(Firebug.MeasureBox, { getValue: function () { }, setValue: function (value) { }, show: function (target, panel, value, textSize, targetSize) { }, hide: function () { }, layout: function (forceAll) { }, getContextMenuItems: function (target) {
                var items = [];
            ...
            Firebug.InlineEditor.prototype = domplate(Firebug.BaseEditor, { enterOnBlur: true, outerMargin: 8, shadowExpand: 7, tag: DIV({ "class": "inlineEditor" }, DIV({ "class": "textEditorTop1" }, DIV({ "class": "textEditorTop2" })), DIV({ "class": "textEditorInner1" }, DIV({ "class": "textEditorInner2" }, INPUT(inlineEditorAttributes))), DIV({ "class": "textEditorBottom1" }, DIV({ "class": "textEditorBottom2" }))), inputTag: INPUT({ "class": "textEditorInner", type: "text", onkeypress: "$onKeyPress", onoverflow: "$onOverflow" }), expanderTag: IMG({ "class": "inlineExpander", src: "blank.gif" }), initialize: function () {
...
element = element.parentNode) {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            XHRSpy.prototype = { method: null, url: null, async: null, xhrRequest: null, href: null, loaded: false, logRow: null, responseText: null, requestHeaders: null, responseHeaders: null, sourceLink: null, getURL: function () {
                return this.href
            } 
            };
...
i++) {
                    ...
                    } with ({ row: spy.logRow, status: xhrRequest.status == 0 ? "" : xhrRequest.status + " " + xhrRequest.statusText, time: duration, success: success }) {
                        setTimeout(function () {
...
++i) {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            Firebug.NetMonitor = extend(Firebug.ActivableModule, { dispatchName: "netMonitor", clear: function (context) {
            ...
            Firebug.NetMonitor.NetInfoBody = domplate(Firebug.Rep, new Firebug.Listener(), { tag: DIV({ "class": "netInfoBody", _repObject: "$file" }, TAG("$infoTabs", { file: "$file" }), TAG("$infoBodies", { file: "$file" })), infoTabs: DIV({ "class": "netInfoTabs focusRow subFocusRow", role: "tablist" }, A({ "class": "netInfoParamsTab netInfoTab a11yFocus", onclick: "$onClickTab", role: "tab", view: "Params", $collapsed: "$file|hideParams" }, $STR("URLParameters")), A({ "class": "netInfoHeadersTab netInfoTab a11yFocus", onclick: "$onClickTab", role: "tab", view: "Headers" }, $STR("Headers")), A({ "class": "netInfoPostTab netInfoTab a11yFocus", onclick: "$onClickTab", role: "tab", view: "Post", $collapsed: "$file|hidePost" }, $STR("Post")), A({ "class": "netInfoPutTab netInfoTab a11yFocus", onclick: "$onClickTab", role: "tab", view: "Put", $collapsed: "$file|hidePut" }, $STR("Put")), A({ "class": "netInfoResponseTab netInfoTab a11yFocus", onclick: "$onClickTab", role: "tab", view: "Response", $collapsed: "$file|hideResponse" }, $STR("Response")), A({ "class": "netInfoCacheTab netInfoTab a11yFocus", onclick: "$onClickTab", role: "tab", view: "Cache", $collapsed: "$file|hideCache" }, $STR("Cache")), A({ "class": "netInfoHtmlTab netInfoTab a11yFocus", onclick: "$onClickTab", role: "tab", view: "Html", $collapsed: "$file|hideHtml" }, $STR("HTML"))), infoBodies: DIV({ "class": "netInfoBodies outerFocusRow" }, TABLE({ "class": "netInfoParamsText netInfoText netInfoParamsTable", role: "tabpanel", cellpadding: 0, cellspacing: 0 }, TBODY()), DIV({ "class": "netInfoHeadersText netInfoText", role: "tabpanel" }), DIV({ "class": "netInfoPostText netInfoText", role: "tabpanel" }), DIV({ "class": "netInfoPutText netInfoText", role: "tabpanel" }), PRE({ "class": "netInfoResponseText netInfoText", role: "tabpanel" }), DIV({ "class": "netInfoCacheText netInfoText", role: "tabpanel" }, TABLE({ "class": "netInfoCacheTable", cellpadding: 0, cellspacing: 0, role: "presentation" }, TBODY({ role: "list", "aria-label": $STR("Cache") }))), DIV({ "class": "netInfoHtmlText netInfoText", role: "tabpanel" }, IFRAME({ "class": "netInfoHtmlPreview", role: "document" }))), headerDataTag: FOR("param", "$headers", TR({ role: "listitem" }, TD({ "class": "netInfoParamName", role: "presentation" }, TAG("$param|getNameTag", { param: "$param" })), TD({ "class": "netInfoParamValue", role: "list", "aria-label": "$param.name" }, FOR("line", "$param|getParamValueIterator", CODE({ "class": "focusRow subFocusRow", role: "listitem" }, "$line"))))), customTab: A({ "class": "netInfo$tabId\\Tab netInfoTab", onclick: "$onClickTab", view: "$tabId", role: "tab" }, "$tabTitle"), customBody: DIV({ "class": "netInfo$tabId\\Text netInfoText", role: "tabpanel" }), nameTag: SPAN("$param|getParamName"), nameWithTooltipTag: SPAN({ title: "$param.name" }, "$param|getParamName"), getNameTag: function (param) {
                ...
                if (limitReached) {
                    ...
                    var object = { text: $STR("net.responseSizeLimitMessage"), onClickLink: function () {
...
i++) {
            ...
            Firebug.NetMonitor.ResponseSizeLimit = domplate(Firebug.Rep, { tag: DIV({ "class": "netInfoResponseSizeLimit" }, SPAN("$object.beforeLink"), A({ "class": "objectLink", onclick: "$onClickLink" }, "$object.linkText"), SPAN("$object.afterLink")), reLink: /^(.*)<a>(.*)<\/a>(.*$)/, append: function (obj, parent) {
            ...
            Firebug.NetMonitor.Utils = { findHeader: function (headers, name) {
                if (!headers) {
                    return null
...
++i) {
                ...
                try {
                    ...
                    if (!file.responseHeaders && Firebug.collectHttpHeaders) {
                        ...
                        http.visitRequestHeaders({ visitHeader: function (name, value) {
                            requestHeaders.push({ name: name, value: value })
                        } 
                        });
                        http.visitResponseHeaders({ visitHeader: function (name, value) {
    ...
    FBL.ns(function () {
        with (FBL) {
            var contexts = [];
            Firebug.Spy = extend(Firebug.Module, { dispatchName: "spy", initialize: function () {
                if (Firebug.TraceModule) {
                    Firebug.TraceModule.addListener(this.TraceListener)
                } Firebug.Module.initialize.apply(this, arguments)
            }, shutdown: function () {
...
++i) {
    ...
    FBL.ns(function () {
        with (FBL) {
            var contentTypes = { "text/javascript": 1, "text/x-javascript": 1, "text/json": 1, "text/x-json": 1, "application/json": 1, "application/x-json": 1, "application/javascript": 1, "application/x-javascript": 1, "application/json-rpc": 1 };
            Firebug.JSONViewerModel = extend(Firebug.Module, { dispatchName: "jsonViewer", initialize: function () {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            Firebug.XMLViewerModel = extend(Firebug.Module, { dispatchName: "xmlViewer", initialize: function () {
                Firebug.Module.initialize.apply(this, arguments);
                Firebug.NetMonitor.NetInfoBody.addListener(this)
            }, shutdown: function () {
                Firebug.Module.shutdown.apply(this, arguments);
...
i++) {
            ...
            Firebug.XMLViewerModel.ParseError = domplate(Firebug.Rep, { tag: DIV({ "class": "xmlInfoError" }, DIV({ "class": "xmlInfoErrorMsg" }, "$error.message"), PRE({ "class": "xmlInfoErrorSource" }, "$error|getSource")), getSource: function (error) {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            var maxQueueRequests = 500;
            Firebug.ConsoleBase = { log: function (object, context, className, rep, noThrottle, sourceLink) {
            ...
            var ActivableConsole = extend(Firebug.ConsoleBase, { isAlwaysEnabled: function () {
                return true
            } 
            });
            Firebug.Console = Firebug.Console = extend(ActivableConsole, { dispatchName: "console", error: function () {
...
m = reg.exec(format)) {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            Firebug.Console.injector = { install: function (context) {
...
i++) {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            Firebug.CommandLine = extend(Firebug.Module, { element: null, isMultiLine: false, isActive: false, initialize: function (doc) {
...
--start) {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            } Firebug.HTML = extend(Firebug.Module, { appendTreeNode: function (nodeArray, html) {
                var reTrim = /^\s+|\s+$/g;
                if (!nodeArray.length) {
                    nodeArray = [nodeArray]
                } for (var n = 0, node;
...
c++) {
            ...
            function HTMLPanel() { } HTMLPanel.prototype = extend(Firebug.Panel, { name: "HTML", title: "HTML", options: { hasSidePanel: true, isPreRendered: !Firebug.flexChromeEnabled, innerHTMLSync: true }, create: function () {
                Firebug.Panel.create.apply(this, arguments);
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            Firebug.InfoTip = extend(Firebug.Module, { dispatchName: "infoTip", tags: domplate({ infoTipTag: DIV({ "class": "infoTip" }), colorTag: DIV({ style: "background: $rgbValue; width: 100px; height: 40px" }, "&nbsp;"), imgTag: DIV({ "class": "infoTipImageBox infoTipLoading" }, IMG({ "class": "infoTipImage", src: "$urlValue", repeat: "$repeat", onload: "$onLoadImage" }), IMG({ "class": "infoTipBgImage", collapsed: true, src: "blank.gif" }), DIV({ "class": "infoTipCaption" })), onLoadImage: function (event) {
                ...
                return true
            }, disable: function () { }, showPanel: function (browser, panel) {
                if (panel) {
        ...
        with (FBL) {
            ...
            CssParser = (function () {
                function rule(start, body_start, end) {
                    return { start: start || 0, body_start: body_start || 0, end: end || 0, line: -1, selector: null, parent: null, children: [], addChild: function (start, body_start, end) {
...
i < il;
i++) {
                        var r = rule_node.children[i], rule_start = text.substring(r.start, r.body_start), cur_len = rule_start.length;
                    ...
                    var result = [0], i = 0, il = text.length, ch, ch2;
                    while (i < il) {
                        ch = text.charAt(i);
                        if (ch == "\n" || ch == "\r") {
...
j++) {
                ...
                } return { read: function (text, startLine) {
                    var rule_start = [], rule_body_start = [], rules = [], in_comment = 0, root = rule(), cur_parent = root, last_rule = null, stack = [], ch, ch2;
                    stack.last = function () {
...
i++) {
                ...
                }, normalizeSelector: normalizeSelector, findBySelector: function (rule_node, selector, source) {
                    var selector = normalizeSelector(selector), result = [];
                    if (rule_node) {
                        for (var i = 0, il = rule_node.children.length;
i < il;
i++) {
...
j++) {
            ...
            var extractSourceData = function (href) {
                var sourceData = { source: null, startLine: 0 };
                if (href) {
...
item = result.iterateNext()) {
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            var domUtils = null;
            var textContent = isIE ? "innerText" : "textContent";
            var CSSDomplateBase = { isEditable: function (rule) {
            ...
            Firebug.CSSModule = extend(Firebug.Module, { freeEdit: function (styleSheet, value) {
            ...
            Firebug.CSSStyleSheetPanel.prototype = extend(Firebug.SourceBoxPanel, { template: domplate({ tag: DIV({ "class": "cssSheet insertInto a11yCSSView" }, FOR("rule", "$rules", CSSRuleTag), DIV({ "class": "cssSheet editable insertBefore" }, "")) }), refresh: function () {
                if (this.location) {
...
i++) {
            ...
            function CSSElementPanel() { } CSSElementPanel.prototype = extend(Firebug.CSSStyleSheetPanel.prototype, { template: domplate({ cascadedTag: DIV({ "class": "a11yCSSView", role: "presentation" }, DIV({ role: "list", "aria-label": $STR("aria.labels.style rules") }, FOR("rule", "$rules", TAG("$ruleTag", { rule: "$rule" }))), DIV({ role: "list", "aria-label": $STR("aria.labels.inherited style rules") }, FOR("section", "$inherited", H1({ "class": "cssInheritHeader groupHeader focusRow", role: "listitem" }, SPAN({ "class": "cssInheritLabel" }, "$inheritLabel"), TAG(FirebugReps.Element.shortTag, { object: "$section.element" })), DIV({ role: "group" }, FOR("rule", "$section.rules", TAG("$ruleTag", { rule: "$rule" })))))), ruleTag: isIE ? DIV({ "class": "cssElementRuleContainer" }, TAG(FirebugReps.SourceLink.tag, { object: "$rule.sourceLink" }), TAG(CSSStyleRuleTag.tag, { rule: "$rule" })) : DIV({ "class": "cssElementRuleContainer" }, TAG(CSSStyleRuleTag.tag, { rule: "$rule" }), TAG(FirebugReps.SourceLink.tag, { object: "$rule.sourceLink" })) }), updateCascadeView: function (element) {
                ...
                if (rules.length || sections.length) {
                    ...
                    CssAnalyzer.externalStyleSheetWarning.tag.append({ object: "The results here may be inaccurate because some stylesheets could not be loaded due to access restrictions. ", link: "more...", href: "http://getfirebug.com/wiki/index.php/Firebug_Lite_FAQ#I_keep_seeing_.22This_element_has_no_style_rules.22" }, this.panelNode)
                } 
            }, getStylesheetURL: function (rule) {
...
++i) {
            ...
            CSSRuleEditor.prototype = domplate(Firebug.InlineEditor.prototype, { insertNewRow: function (target, insertWhere) {
...
sheet = sheet.parentStyleSheet) { } return sheet.ownerNode
    ...
    FBL.ns(function () {
        with (FBL) {
            Firebug.Script = extend(Firebug.Module, { getPanel: function () {
            ...
            function ScriptPanel() { } ScriptPanel.prototype = extend(Firebug.Panel, { name: "Script", title: "Script", selectIndex: 0, sourceIndex: -1, options: { hasToolButtons: true }, create: function () {
                Firebug.Panel.create.apply(this, arguments);
                this.onChangeSelect = bind(this.onChangeSelect, this);
                var doc = Firebug.browser.document;
...
i++) {
            ...
            DOMMainPanel.prototype = extend(Firebug.DOMBasePanel.prototype, { onClickStatusBar: function (event) {
                var target = event.srcElement || event.target;
...
row = row.previousSibling) {
            ...
            var lastHighlightedObject;
            function DOMSidePanel() { } DOMSidePanel.prototype = extend(Firebug.DOMBasePanel.prototype, { selectRow: function (row, target) {
                if (!target) {
                    target = row.lastChild.firstChild
                } if (!target || !target.repObject) {
                    return
    ...
    FBL.ns(function () {
        with (FBL) {
            if (!Env.Options.enableTrace) {
                return
            } Firebug.Trace = extend(Firebug.Module, { getPanel: function () {
            ...
            function TracePanel() { } TracePanel.prototype = extend(Firebug.Panel, { name: "Trace", title: "Trace", options: { hasToolButtons: true, innerHTMLSync: true }, create: function () {
                Firebug.Panel.create.apply(this, arguments);
